	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-12 text-center marginTOP">
			...
			<div style="width:60%; margin:auto; text-align:left;">
				Telefone: +351 212 564 862 <br>
				Email: icond@condominios.pt <br>
				Skype: iCond
			</div>
		</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-12 text-center marginTOP">
			...
			<hr class="style14">
			<br>
			<div style="width:60%; margin:auto; text-align:left;" class="text-justify">
				Quisque sodales ut elit sed pharetra. 
				Donec euismod at mi ut auctor. 
				Ut bibendum.
			</div>
		</div>
	</div>
